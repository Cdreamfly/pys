...
driver.get("http://zjt.icitpower.com/pc/Console/Login.aspx")
driver.maximize_window()
## login
driver.find_element_by_id("txtUserName").click()
driver.find_element_by_id("txtUserName").send_keys("17550099008")#账号
driver.find_element_by_id("txtUserPwd").click()
